...
- Do not invent employee names, company names, dates, or dollar amounts. Do not mention a date, month, or year anywhere in the report — not in the title, businessPurpose, comment, or receipt fields.
...
function buildExpenseUserContent({ prompt, receiptCount, receiptPrompts, today }) {
  ...
  return `Today's date: ${todayStr} (for your context only — do not put this or any other date, month, or year in the report)
